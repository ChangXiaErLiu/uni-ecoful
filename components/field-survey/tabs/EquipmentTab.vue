				...
				<view class="search-action-bar">
					...
					<view class="action-buttons">
						...
						<button class="btn btn-refresh" @tap="handleFetchEquipment" :disabled="loadingEquipment">
							<uni-icons :type="loadingEquipment ? 'spinner-cycle' : 'refresh'" size="16" :color="loadingEquipment ? '#94a3b8' : '#ffffff'" />
...
@media (min-width: 768px) {
	...
	.header-index {flex: 0.2;}
	.header-name { flex: 0.9; }
	.header-quantity { flex: 1.2; }
	.header-remark { flex: 2.2; }
	.header-photo { flex: 2; }
	...
	/* .cell-index { flex: 0.1; } */
	.cell-name { flex: 1.0; }
	.cell-quantity { flex: 1.2; }
	.cell-remark { flex: 2.2; }
	.cell-photo { flex: 2; }
	.cell-action { flex: 0.5; }
